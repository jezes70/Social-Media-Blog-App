...
function transformCache(input) {
    ...
    if (input === 'redis' || input === 'ioredis' || input === 'database' || input === 'ioredis/cluster') {
        let options;
        if (hasProcessEnv([
            EnvironmentVariableName.CACHE_OPTIONS,
            EnvironmentVariableName.CACHE_OPTIONS_ALT
        ])) {
...
function useEnv(key) {
    ...
    const output = {
        env: readFromProcessEnv(EnvironmentVariableName.ENV, EnvironmentName.DEVELOPMENT),
        // Seeder
