...
function hasProcessEnv(key) {
    ...
    for(let i = 0; i < keys.length; i++){
        if (hasOwnProperty(process$1.env, keys[i])) {
            return true;
        }
    }
    return false;
...
function transformCache(input) {
    ...
    if (input === 'redis' || input === 'ioredis' || input === 'database' || input === 'ioredis/cluster') {
        let options;
        if (hasProcessEnv([
            exports.EnvironmentVariableName.CACHE_OPTIONS,
            exports.EnvironmentVariableName.CACHE_OPTIONS_ALT
        ])) {
            const temp = readFromProcessEnv([
                exports.EnvironmentVariableName.CACHE_OPTIONS,
                exports.EnvironmentVariableName.CACHE_OPTIONS_ALT
            ]);
            if (temp) {
        ...
        return {
            ...
            alwaysEnabled: readBoolFromProcessEnv([
                exports.EnvironmentVariableName.CACHE_ALWAYS_ENABLED,
                exports.EnvironmentVariableName.CACHE_ALWAYS_ENABLED_ALT
            ]),
            duration: readIntFromProcessEnv([
                exports.EnvironmentVariableName.CACHE_DURATION,
                exports.EnvironmentVariableName.CACHE_DURATION_ALT
            ])
        };
    }
    return undefined;
...
function useEnv(key) {
    ...
    const output = {
        env: readFromProcessEnv(exports.EnvironmentVariableName.ENV, exports.EnvironmentName.DEVELOPMENT),
        // Seeder
        seeds: transformStringToArray(readFromProcessEnv([
            exports.EnvironmentVariableName.SEEDS,
            exports.EnvironmentVariableName.SEEDS_ALT
        ])),
        factories: transformStringToArray(readFromProcessEnv([
            exports.EnvironmentVariableName.FACTORIES,
            exports.EnvironmentVariableName.FACTORIES_ALT
        ])),
        // Database
        url: readFromProcessEnv([
            exports.EnvironmentVariableName.URL,
            exports.EnvironmentVariableName.URL_ALT
        ]),
        host: readFromProcessEnv([
            exports.EnvironmentVariableName.HOST,
            exports.EnvironmentVariableName.HOST_ALT
        ]),
        port: readIntFromProcessEnv([
            exports.EnvironmentVariableName.PORT,
            exports.EnvironmentVariableName.PORT_ALT
        ]),
        username: readFromProcessEnv([
            exports.EnvironmentVariableName.USERNAME,
            exports.EnvironmentVariableName.USERNAME_ALT
        ]),
        password: readFromProcessEnv([
            exports.EnvironmentVariableName.PASSWORD,
            exports.EnvironmentVariableName.PASSWORD_ALT
        ]),
        database: readFromProcessEnv([
            exports.EnvironmentVariableName.DATABASE,
            exports.EnvironmentVariableName.DATABASE_ALT
        ]),
        sid: readFromProcessEnv([
            exports.EnvironmentVariableName.SID,
            exports.EnvironmentVariableName.SID_ALT
        ]),
        schema: readFromProcessEnv([
            exports.EnvironmentVariableName.SCHEMA,
            exports.EnvironmentVariableName.SCHEMA_ALT
        ]),
        extra: readFromProcessEnv([
            exports.EnvironmentVariableName.DRIVER_EXTRA,
            exports.EnvironmentVariableName.DRIVER_EXTRA_ALT
        ]),
        synchronize: readBoolFromProcessEnv([
            exports.EnvironmentVariableName.SYNCHRONIZE,
            exports.EnvironmentVariableName.SYNCHRONIZE_ALT
        ]),
        schemaDrop: readBoolFromProcessEnv([
            exports.EnvironmentVariableName.SCHEMA_DROP,
            exports.EnvironmentVariableName.SCHEMA_DROP_ALT
        ]),
        migrationsRun: readBoolFromProcessEnv([
            exports.EnvironmentVariableName.MIGRATIONS_RUN,
            exports.EnvironmentVariableName.MIGRATIONS_RUN_ALT
        ]),
        entities: transformStringToArray(readFromProcessEnv([
            exports.EnvironmentVariableName.ENTITIES,
            exports.EnvironmentVariableName.ENTITIES_ALT
        ])),
        migrations: transformStringToArray(readFromProcessEnv([
            exports.EnvironmentVariableName.MIGRATIONS,
            exports.EnvironmentVariableName.MIGRATIONS_ALT
        ])),
        migrationsTableName: readFromProcessEnv([
            exports.EnvironmentVariableName.MIGRATIONS_TABLE_NAME,
            exports.EnvironmentVariableName.MIGRATIONS_TABLE_NAME_ALT
        ]),
        metadataTableName: readFromProcessEnv([
            exports.EnvironmentVariableName.METADATA_TABLE_NAME,
            exports.EnvironmentVariableName.METADATA_TABLE_NAME_ALT
        ]),
        subscribers: transformStringToArray(readFromProcessEnv([
            exports.EnvironmentVariableName.SUBSCRIBERS,
            exports.EnvironmentVariableName.SUBSCRIBERS_ALT
        ])),
        logging: transformLogging(readFromProcessEnv([
            exports.EnvironmentVariableName.LOGGING,
            exports.EnvironmentVariableName.LOGGING_ALT
        ])),
        logger: readFromProcessEnv([
            exports.EnvironmentVariableName.LOGGER,
            exports.EnvironmentVariableName.LOGGER_ALT
        ]),
        entityPrefix: readFromProcessEnv([
            exports.EnvironmentVariableName.ENTITY_PREFIX,
            exports.EnvironmentVariableName.ENTITY_PREFIX_ALT
        ]),
        maxQueryExecutionTime: readIntFromProcessEnv([
            exports.EnvironmentVariableName.MAX_QUERY_EXECUTION_TIME,
            exports.EnvironmentVariableName.MAX_QUERY_EXECUTION_TIME_ALT
        ]),
        debug: readFromProcessEnv([
            exports.EnvironmentVariableName.DEBUG,
            exports.EnvironmentVariableName.DEBUG_ALT
        ]),
        cache: transformCache(readFromProcessEnv([
            exports.EnvironmentVariableName.CACHE,
            exports.EnvironmentVariableName.CACHE_ALT
        ])),
        uuidExtension: readFromProcessEnv([
            exports.EnvironmentVariableName.UUID_EXTENSION,
            exports.EnvironmentVariableName.UUID_EXTENSION_ALT
        ])
    };
    if (output.extra) {
    ...
    let type;
    if (hasProcessEnv([
        exports.EnvironmentVariableName.TYPE,
        exports.EnvironmentVariableName.TYPE_ALT
    ])) {
        type = readFromProcessEnv([
            exports.EnvironmentVariableName.TYPE,
            exports.EnvironmentVariableName.TYPE_ALT
        ]);
